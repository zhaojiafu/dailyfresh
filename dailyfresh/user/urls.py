...
urlpatterns = [
    ...
    # 地址编辑
    url(r'^address_show$', views.address_show, name="address_show"),  # 用户全部收货地址页
    url(r'^address_all$', views.UserAddressAllView.as_view(), name="address_all"),  # 用户全部收货地址页
    url(r'^remove_addr/(?P<Rmpk>.*)$', views.remove_addr, name="remove_addr"),  # 用户全部收货地址页
    url(r'^address/(?P<Uppk>.*)$', views.UpdateAddress.as_view(), name="update_addr"),  # 用户收货地址页
    url(r'^update_is_default/(?P<Updefault>.*)$', views.UpdateDefault.as_view(), name="update_is_default"),  # 用户收货地址页
